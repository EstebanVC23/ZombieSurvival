...
class UIManager:
    ...
    def __init__(self, player):
        ...
        # Fondo de la tarjeta
        card_bg_path = os.path.join("assets", "images", "ui", "card_bg.png")
        if os.path.exists(card_bg_path):
            self.card_bg = pygame.image.load(card_bg_path).convert_alpha()
        ...
        # Imagen del jugador (sin fondo)
        player_img_path = os.path.join("assets", "images", "player", "player_static.png")
        if os.path.exists(player_img_path):
            ...
            # Limpieza de fondo blanco o claro
            img.lock()
    ...
    def draw_rounded_rect_with_border(self, surface, rect, color_bg, color_border, radius, border_thickness=3, separation=2):
        """Dibuja un rectángulo redondeado con doble borde rojo y espacio entre ellos."""
        x, y, w, h = rect
        # Fondo
        ...
        # Borde interno (2 px hacia adentro)
    ...
    def draw_player_card(self, screen, font, screen_width, screen_height):
        ...
        # Fondo translúcido oscuro detrás
        ...
        self.draw_rounded_rect_with_border(screen, card_rect, (20, 20, 20, 220), (200, 30, 30), radius=30, border_thickness=3, separation=2)
